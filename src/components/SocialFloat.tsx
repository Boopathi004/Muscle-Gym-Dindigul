    ...
    <div
      className={`fixed z-50 flex items-center ${
        isMobile 
          ...
          : "right-4 top-1/2 -translate-y-1/2 flex-col gap-3"
      }`}
      style={{
        opacity: visible ? 1 : 0,
        transform: isMobile
    ...
    >
      ...
      <a
        ...
        style={{
          ...
          transform: hovered === "ig" ? `scale(1.12)${isMobile ? '' : ' translateX(-4px)'}` : "scale(1)",
          cursor: "pointer",
        }}
      >
      ...
      <a
        ...
        style={{
          ...
          backdropFilter: "blur(12px)",
          transition: "all 0.3s cubic-bezier(0.34,1.56,0.64,1)",
          transform: hovered === "wa" ? `scale(1.12)${isMobile ? '' : ' translateX(-4px)'}` : "scale(1)",
          cursor: "pointer",
        }}
      >
